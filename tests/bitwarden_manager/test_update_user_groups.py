...
def test_update_user_groups_missing_collection_names() -> None:
    ...
    assert expected == UpdateUserGroups._missing_collection_names(teams, existing_collections)
...
def test_non_ump_based_group_ids() -> None:
    ...
    assert ["id-team-three", "id-team-four"] == UpdateUserGroups._non_ump_based_group_ids(groups=groups, teams=teams)
