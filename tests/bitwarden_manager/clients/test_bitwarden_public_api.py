...
def test_invite_user() -> None:
    ...
    with responses.RequestsMock(assert_all_requests_are_fired=True) as rsps:
        ...
        rsps.add(
            responses.POST,
            "https://api.bitwarden.us/public/members",
            match=[
...
def test_failed_login() -> None:
    ...
    with responses.RequestsMock(assert_all_requests_are_fired=True) as rsps:
        rsps.add(
            responses.POST,
            "https://identity.bitwarden.us/connect/token",
            body="",
            status=500,
            content_type="application/json",
        )
        ...
        with pytest.raises(
            Exception,
            match="Failed to authenticate with " "https://identity.bitwarden.us/connect/token, " "creds incorrect?",
        ):
...
def test_create_group() -> None:
    ...
    with responses.RequestsMock(assert_all_requests_are_fired=True) as rsps:
        rsps.add(
            responses.POST,
            "https://api.bitwarden.us/public/groups",
...
def test_get_user_groups_failure() -> None:
    ...
    with responses.RequestsMock() as rsps:
        rsps.add(
            ...
            content_type="application/json",
            method="GET",
            url=f"https://api.bitwarden.us/public/members/{user_id}/group-ids",
            json={},
        )
...
def test_list_existing_collections() -> None:
    ...
    with responses.RequestsMock(assert_all_requests_are_fired=True) as rsps:
        rsps.add(
            ...
            content_type="application/json",
            method="GET",
            url="https://api.bitwarden.us/public/collections",
            json={
                "data": [
...
def test_update_collection_groups_success() -> None:
    ...
    with responses.RequestsMock(assert_all_requests_are_fired=True) as rsps:
        rsps.add(
            responses.GET,
            f"https://api.bitwarden.us/public/collections/{collection_id}",
            status=200,
            json=_collection_object_with_base64_encoded_external_id(collection_name),
        )
        rsps.add(
...
def test_collate_user_group_ids() -> None:
    ...
    with responses.RequestsMock(assert_all_requests_are_fired=False) as rsps:
        rsps.add(
            ...
            content_type="application/json",
            method="GET",
            url=f"https://api.bitwarden.us/public/collections/{_collection_id(team_one_name)}",
        ...
        rsps.add(
            ...
            content_type="application/json",
            method="GET",
            url=f"https://api.bitwarden.us/public/collections/{_collection_id(team_two_name)}",
...
MOCKED_LOGIN = responses.Response(
    method="POST",
    url="https://identity.bitwarden.us/connect/token",
    status=200,
    json={
...
def test_remove_user(caplog: LogCaptureFixture) -> None:
    ...
    with responses.RequestsMock(assert_all_requests_are_fired=True) as rsps:
        ...
        rsps.add(
            responses.DELETE,
            "https://api.bitwarden.us/public/members/22222222",
            status=200,
            content_type="application/json",
        )
        ...
        rsps.assert_call_count("https://api.bitwarden.us/public/members/22222222", 1) is True
...
def test_reinvite_user(caplog: LogCaptureFixture) -> None:
    with responses.RequestsMock(assert_all_requests_are_fired=True) as rsps:
        ...
        rsps.add(
            responses.POST,
            "https://api.bitwarden.us/public/members/22222222/reinvite",
            status=200,
            content_type="application/json",
        )
